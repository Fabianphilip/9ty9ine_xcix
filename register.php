        ...
        <?php  
	        ...
	        if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['signup'])) {  
	            ...
	            elseif ($password != $c_password) {
	                ...
	                if(strlen($full_name) < 40 && strlen($phone) < 18 && strlen($email) < 50 && strlen($address) < 50 && strlen($city) < 50){
                           ...
                           <div class="social-login" style="display: none;">
                            ...
                            <form method="post" action="#">
                                ...
                                <p class="login-submit">
                                    <input type="submit" name="signup" value="Register" class="button-primary" style="background-color: black;">
                                </p>
                            </form>
