...
<?php              
    ...
    $result = mysqli_query($conn, "SELECT * FROM payments {$where}");
    $count = mysqli_num_rows($result);
    $per_view = 40;
    $per_view = (!empty($no_of_rows))?$no_of_rows:$per_view;
    $page_link = "restrict/manager-payments?pn=";
    $link_suffix = "";
    $style_class = "";
    page_numbers();
    $offset = ($per_view * $pn) - $per_view;
    
    $result = mysqli_query($conn, "SELECT * FROM payments $where ORDER BY id DESC LIMIT {$offset},{$per_view}");
?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row d-flex justify-content-center">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="row d-flex" style="width: 70px;">
                                                                        <div class="col-auto px-0"><a href="manage-payments?view=<?php echo $row['id'] ?>" class="btn btn-primary m-1"><i class="fa fa-eye"></i></a></div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <?php
                        ...
                        <?php if(!empty($view)){ ?>
                            <?php
                                $query_view = mysqli_query($conn, "SELECT * FROM payments WHERE id = '$view'");
                            ...
                            <div class="col-md-8 p-2 my-0">
                                <a href="manage-payments" class="btn btn-primary float-right mx-2" style="float: right;"> Go Back </a>
                            </div>
                            <hr>
                            ...
                            <div class="col-md-12">
                                <div class="card p-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">Plan:</div><div class="col-md-9"><?php echo $row['plan'] ?></div>
                                    </div><hr>
                                    <div class="row">
